        ...
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-5 d-flex justify-content-end align-items-center">
            ...
            <?php if(isset($_SESSION['username'])){ ?>
                ...
                <a class="btn btn-sm btn-outline-secondary" href="<?php echo wp_logout_url();?>">Logout</a>

           <?php }else{?>
            <a class="btn btn-sm btn-outline-secondary" href="<?php echo bloginfo( 'url' ).'/login'?>">Sign up</a>
            <?php }?>
          </div>
        </div>
      </header>
